...
{
    public class PickUpPatientToScheduleTheVaccinePageViewModel : ViewModelBase
    {
        private readonly IApi _api;
        private Patient _patient = new Patient();
        public PickUpPatientToScheduleTheVaccinePageViewModel(IApi api, INavigationService navigationService) : base(navigationService)
        {
